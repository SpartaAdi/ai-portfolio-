[discovery-framework.md](https://github.com/user-attachments/files/28384818/discovery-framework.md)
---
...
worth watching for — Q6 in my original list was [YOUR COMPANY]'s value proposition dressed up as
...
file are designed to surface information that changes how [YOUR COMPANY] positions — not to
...
research. Walking into a [CLIENT] call and asking "what cloud provider are you on?" when
...
- [YOUR COMPANY] services being explored (Professional Services / AI / both)
...
- [YOUR COMPANY] services being explored: [PROFESSIONAL SERVICES / AI CONSULTING / BOTH]
- Discovery mode: [PS ONLY / AI ONLY / BOTH]
...
this engagement internally — the person who will sell it when [YOUR COMPANY] is not
in the room.
...
information that directly changes how [YOUR COMPANY] positions its services.
...
**Live test result ([CLIENT], May 2026):** Stakeholder questions correctly anchored to
...
occasionally produce these, especially when you describe [YOUR COMPANY]'s capabilities in the
