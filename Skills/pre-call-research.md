[pre-call-research.md](https://github.com/user-attachments/files/28384803/pre-call-research.md)
---
...
than for a 10-minute call prep window.
...
- Your company's relevant service (what you're positioning)
...
Your company context: [YOUR COMPANY'S RELEVANT SERVICE]
Today's date: [DATE]
...
**Live test result ([CLIENT], May 2026):** Base prompt produced a usable brief in one
...
current reality. In the [CLIENT] test, it returned a CEO who had already been replaced.
...
Claude surfaced Azure for [CLIENT] but missed AWS entirely. It stops searching once it
...
confirmation on high-stakes calls. For an AWS-focused consultancy, a missed AWS
